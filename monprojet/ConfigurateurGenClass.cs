...
namespace PTLGClassLibrary
{
    ...
    public class ConfigurateurGenClass : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            ConfigurateurGenForm f = new ConfigurateurGenForm();

            ConfGen.G_DataFromGUI.DataInitialisation(passerelleSelectionneeElement, f);
            ConfGen.G_DataFromGUI.MaxiValues(f);
            ConfGen.G_DataFromGUI.ThirdSupport(f);
            ConfGen.G_LabelsBackColors.ColoringMaxValuesErrors(f);
            ...
            {
                ConfGen.G_DataFromGUI.MaxiValues(f);
                ConfGen.G_DataFromGUI.DataUpdate(f);
                ConfGen.G_DataFromGUI.ThirdSupport(f);
                ConfGen.G_LabelsBackColors.ColoringMaxValuesErrors(f);

                ConfGen.G_DataFromGUI.TestIndexComboBox(f);
            };
            ...
            {
                Transaction trButton = new Transaction(doc, "Configuration PTLG Général");
                {
                    trButton.Start();
                    ...
                    if (passerelleSelectionneeElement.Name.Contains("M3") && f.troisiemeAttacheCheckBox.Checked)
                    {
                    ...
                    // supprimer toujour la quatrième attache
                    ...
                    else
                    {
                        ...
                        passerelleSelectionneeElement.LookupParameter("RH").Set(LectureCSVstr("Reactions", ligneReaction, 3));
                        passerelleSelectionneeElement.LookupParameter("RV").Set(LectureCSVstr("Reactions", ligneReaction, 4));
                        passerelleSelectionneeElement.LookupParameter("RU").Set(LectureCSVstr("Reactions", ligneReaction, 5));
                        passerelleSelectionneeElement.LookupParameter("RA").Set(LectureCSVstr("Reactions", ligneReaction, 6));
                        passerelleSelectionneeElement.LookupParameter("RB").Set(LectureCSVstr("Reactions", ligneReaction, 7));
                        passerelleSelectionneeElement.LookupParameter("RC").Set(LectureCSVstr("Reactions", ligneReaction, 8));
                        passerelleSelectionneeElement.LookupParameter("R2").Set(LectureCSVstr("Reactions", ligneReaction, 9));
                        passerelleSelectionneeElement.LookupParameter("R1").Set(LectureCSVstr("Reactions", ligneReaction, 10));
                        passerelleSelectionneeElement.LookupParameter("RH'").Set(LectureCSVstr("Reactions", ligneReaction, 11));
                    }
                    #endregion REACTIONS

                    #region passerelle incorrecte
                    ...
                    #endregion passerelle incorrecte
            ...
            ConfigurateurFootOptions.FootOptionsGen(f, passerelleSelectionneeElement, doc);
